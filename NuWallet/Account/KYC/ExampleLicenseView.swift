...
class ExampleLicenseView: UIView {
    static let exampleLicenseView = ExampleLicenseView()
    ...
    override init(frame: CGRect) {
        ...
        Bundle.main.loadNibNamed("ExampleLicenseView", owner: self)
        commitInit()
    }
